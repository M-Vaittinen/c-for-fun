    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 15 15" style="fill:#ffffff; margin-right: 5px; vertical-align: middle;"><path d="M 8.992188 1.019531 C 8.65625 1.167969 8.4375 1.507812 8.4375 1.875 L 8.4375 3.75 L 5.15625 3.75 C 2.308594 3.75 0 6.058594 0 8.90625 C 0 12.226562 2.386719 13.707031 2.9375 14.007812 C 3.007812 14.046875 3.089844 14.0625 3.171875 14.0625 C 3.492188 14.0625 3.75 13.800781 3.75 13.484375 C 3.75 13.265625 3.625 13.0625 3.460938 12.914062 C 3.1875 12.652344 2.8125 12.140625 2.8125 11.25 C 2.8125 9.695312 4.070312 8.4375 5.625 8.4375 L 8.4375 8.4375 L 8.4375 10.3125 C 8.4375 10.679688 8.65625 11.019531 8.992188 11.167969 C 9.335938 11.316406 9.726562 11.257812 10 11.007812 L 14.6875 6.789062 C 14.886719 6.613281 15 6.359375 15 6.09375 C 15 5.828125 14.890625 5.574219 14.6875 5.398438 L 10 1.175781 C 9.726562 0.929688 9.332031 0.867188 8.992188 1.019531 Z M 8.992188 1.019531 "/></svg>Share</button><div id="popup_" style=" position: fixed; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0,0,0,0.5); display: none; justify-content: center; align-items: center;">
        ...
        <path d="M13.723 18.654l-3.61 3.609c-2.316 2.315-6.063 2.315-8.378 0-1.12-1.118-1.735-2.606-1.735-4.188 0-1.582.615-3.07 1.734-4.189l4.866-4.865c2.355-2.355 6.114-2.262 8.377 0 .453.453.81.973 1.089 1.527l-1.593 1.592c-.18-.613-.5-1.189-.964-1.652-1.448-1.448-3.93-1.51-5.439-.001l-.001.002-4.867 4.865c-1.5 1.499-1.5 3.941 0 5.44 1.517 1.517 3.958 1.488 5.442 0l2.425-2.424c.993.284 1.791.335 2.654.284zm.161-16.918l-3.574 3.576c.847-.05 1.655 0 2.653.283l2.393-2.389c1.498-1.502 3.94-1.5 5.44-.001 1.517 1.518 1.486 3.959 0 5.442l-4.831 4.831-.003.002c-1.438 1.437-3.886 1.552-5.439-.002-.473-.474-.785-1.042-.956-1.643l-.084.068-1.517 1.515c.28.556.635 1.075 1.088 1.528 2.245 2.245 6.004 2.374 8.378 0l4.832-4.831c2.314-2.316 2.316-6.062-.001-8.377-2.317-2.321-6.067-2.313-8.379-.002z"></path></svg>
         <span style="color:#000000 !important;"><span style="margin-left: 10px;">Kopioi linkki</span></span>
            ...
            <a href="mailto:?subject=Kokeilemani Dominionkortit&amp;body='.$url.'" style="display: flex; align-items: center; text-decoration: none; color:#000000 !important;">
        ...
        <span style="margin-left: 10px;color:#000000 !important;">Email</span>
            ...
            <li style="width: 48%; font-size: 16px; margin-bottom: 10px;">
            <a href="https://www.tumblr.com/widgets/share/tool?canonicalUrl='.$url.'" style="display: flex; align-items: center; text-decoration: none; color:#000000 !important;">
        ...
        <span style="margin-left: 10px;color:#000000 !important;">Tumblr</span>
            ...
            <li style="width: 48%; font-size: 16px; margin-bottom: 10px;">
            <a href="https://facebook.com/sharer.php?u='.$url.'" style="display: flex; align-items: center; text-decoration: none; color:#000000 !important;">
        ...
        <span style="margin-left: 10px;color:#000000 !important;">Facebook</span>
            ...
            <li style="width: 48%; font-size: 16px; margin-bottom: 10px;">
            <a href="https://www.reddit.com/submit?url='.$url.'" style="display: flex; align-items: center; text-decoration: none; color:#000000 !important;">
        ...
        <span style="margin-left: 10px;color:#000000 !important;">Reddit</span>
            ...
            <li style="width: 48%; font-size: 16px; margin-bottom: 10px;">
            <a href="https://wa.me/?text='.$url.'" style="display: flex; align-items: center; text-decoration: none; color:#000000 !important;">
        ...
        <span style="margin-left: 10px;color:#000000 !important;">WhatsApp</span>
            ...
            <li style="width: 48%; font-size: 16px; margin-bottom: 10px;">
            <a href="discord://send?message='.$url.'" style="display: flex; align-items: center; text-decoration: none; color:#000000 !important;">
